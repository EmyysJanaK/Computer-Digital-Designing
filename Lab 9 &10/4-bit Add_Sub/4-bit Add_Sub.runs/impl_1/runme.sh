...
HD_PWD='C:/Users/janak/Lab10/4-bit Add_Sub/4-bit Add_Sub.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Add_Sub_4_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Add_Sub_4_bit.tcl -notrace
