...
HD_PWD='C:/Users/janak/Lab10/4-bit Add_Sub/4-bit Add_Sub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Add_Sub_4_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Add_Sub_4_bit.tcl
